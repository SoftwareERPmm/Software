...
export type Period = {
  ...
  short: string;
  /** Mid-sentence, carrying its own preposition: "Sales this month",
   *  "Sales in the last 3 months". "in this month" is not English. */
  sentence: string;
