...
export default async function ImportBankReceipts() {
  ...
  return (
    <>
      <div className="page-head">
        ...
        <h1>Import bank receipts</h1>
        <span className="page-sub">
          A spreadsheet of receipts, posted as bank vouchers — the same two lines the
        ...
        <Link href="/finance/bank-receipt" className="btn ghost">Enter one by hand</Link>
      </div>

      <VoucherImport kind="bank" action={runVoucherImport} />
